    ...
    "certification": [
        {
            ...
            "description": "Rest API Backend web services automation, end to end automation along with best practices and real time application testing"
        },
        {
            "icon": "bx bx-cog",
            ...
            "description": "Selenium Automation of Any Real world web Applications, along with custom framework building from scratch"
        },
        {
            "icon": "bx bx-tachometer",
            "title": "JMeter - Performance Testing",
            "certificateUrl": "https://www.udemy.com/certificate/UC-e37c69f0-efdc-4683-841c-e6513c1de00e/",
        ...
        },
        {
            ...
            "certificateUrl": "https://www.udemy.com/certificate/UC-7538b86e-9ea8-4a54-8c3b-700a899fb986/",
        ...
        },
        {
            ...
            "certificateUrl": "https://www.udemy.com/certificate/UC-b9c9a89d-460d-41d3-bac1-a6bf4a5b75dc/",
            "description": "Very Solid Understanding and Hands-On Experience with Git and related source control concepts."
        },
        {
            "icon": "bx bxl-figma",
            "title": "Figma UI / UX Design Essentials",
            "certificateUrl": "https://www.udemy.com/certificate/UC-fcad9e51-ca1a-43ee-bfa7-2d1fd54b6018/",
            "description": "Design Interface using Powerfull tools like constraints for responsive layouts"
        },
        {
            "icon": "bx bx-abacus",
            "title": "GMath - Permutations and Combinations",
            "certificateUrl": "https://www.udemy.com/certificate/UC-e282a8d7-1557-4960-9b48-18de348158a9/",
            "description": "Well Researched Explanations as well as time saving techniques for Solving Permutations and Combinations (PnC) problems"
        }
    ],
    "contact": {
        ...
        "details": [
            {
                ...
                "categoryDetails": [
                    ...
                    },
                    {
                        ...
                        "summary": "<strong><em>Completed Bachelors degree with distinction & Institute level bronze medalist</em></strong>",
                        "descriptionType": null,
                        "description": null,
                        "shortDescription": null
                    },
                ...
                "categoryDetails": [
                    {
                        ...
                        "highlight": "Framework Enhancement",
                        "summary": null,
                        "descriptionType": null,
                        "description": [
                            "Designed an Automation framework based on selenium implementing a Page-Object Model, Extent Report and query based data extraction from excel with filtering algorithm to speed up scripting upto 5X for test suites."
                        ],
                        "shortDescription": null
                    },
                    {
                        ...
                        "descriptionType": null,
                        "description": [
                            "Created an application specific tool which follow the specified pattern of xpath extraction. To completely automate the process of navigations thereby increasing automation teams productivity."
                        ],
                        "shortDescription": null
                    }
                ]
                ...
                "categoryDetails": [
                    {
                        ...
                        "highlight": "Automation framework",
                        "summary": null,
                        "descriptionType": null,
                        "description": [
                            "Created a REST-Assured based automation framework with in-built dynamic header management and embedded OAuth token generation mechanism with Apache poi based test data and integrated mongoDb support for centralized and parallel test suite execution."
                        ],
                        "shortDescription": null
                    },
                    {
                        "title": "Velocity template integration",
                        "highlight": "Framework Enhancement",
                        "summary": null,
                        "descriptionType": null,
                        "description": [
                            "Dynamic generation of json upon test execution to enable hassle free test data maintenance with increased productivity."
                        ],
                        "shortDescription": null
                    },
                    {
                        "title": "Jira Integration",
                        "highlight": "Jira , TestNG",
                        "summary": null,
                        "descriptionType": null,
                        "description": [
                            "Embedded Jira Integration to the custom developed framework. Which enables local or over the cloud executed test cases to reflect the live result status in jira eliminating the need of manual updation"
                        ],
                        "shortDescription": null
                    }
                ]
            },
            {
                ...
                "categoryDetails": [
                    {
                        "title": "Single Touch Regression Suite",
                        "highlight": "Jenkins",
                        "summary": null,
                        "descriptionType": null,
                        "description": [
                            "Enabled test cases from multiple projects to be executed in multiple environments with a simple customizable parametrized jenkins job."
                        ],
                        "shortDescription": null
                    },
                    {
                        ...
                        "descriptionType": null,
                        "description": [
                            "Highly flexible environment monitoring tool for over 20+ Api's in 12 enviroment with scheduled reports being sent to the clients."
                        ],
                        "shortDescription": null
                    }
                ]
